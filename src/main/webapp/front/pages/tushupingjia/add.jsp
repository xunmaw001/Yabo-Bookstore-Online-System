		...
		<div id="app">
			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
                        ...
                        <div class="layui-input-block">
                            <select name="tushumingcheng" id="tushumingcheng" lay-filter="tushumingcheng">
                                <option value="">请选择</option>
                                <option v-for="(item,index) in tushumingcheng" v-bind:key="index" :value="item">{{item}}</option>
                            </select>
                        </div>
                    </div>
                                                                                <div class="layui-form-item" pane>
		...
		<script>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
					...
					if (res.data.list.length > 0) {
						...
						carousel.render({
							...
							indicator: "none"
                																...
                																http.request(`option/tushuxinxi/tushumingcheng`,'get',{},(res)=>{
					vue.tushumingcheng = res.data
				});
				form.on('select(tushumingcheng)', (data) => {
					console.log(data.value);
					http.request('follow/tushuxinxi/tushumingcheng', 'get', {
						columnValue: data.value
					}, function(res) {
																																										jquery("#tushufenlei").val(res.data.tushufenlei)
																																																																																																					})
				});
				...
				form.on('submit(*)', function(data) {
					...
					// 提交数据
					http.requestJson('tushupingjia' + '/add', 'post', data, function(res) {
					 	layer.msg('提交成功', {
					 		time: 2000,
					 		icon: 6
					 	}, function() {
