...
<body>
					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>图书评价管理</span></li>
								<li class="breadcrumb-item active"><span>编辑图书评价</span></li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>图书名称</label>
										<select  class="form-control"  name="tushumingcheng" id="tushumingchengSelect" onchange="tushumingchengSelect2Change()">
										</select>
									</div>
									<div class="form-group col-md-6">
										<label>图书分类</label>
										<input id="tushufenlei" name="tushufenlei" class="form-control"  value="" readonly>
									</div>
									<div class="form-group col-md-6">
										<label>评分</label>
	...
	<script>
		...
		var crossRuleForm = {};
			...
			function tushumingchengSelect2(){
				http("option/tushuxinxi/tushumingcheng","GET",{
					tableName: "tushuxinxi",
					columnName: "tushumingcheng"
				},(res)=>{
					if(res.code == 0){
						var options = res.data;
						var option = document.createElement("option");
						$("#tushumingchengSelect").append(option)
						for(var i=0;i<options.length;i++){
							var tushumingchengOption = document.createElement("option");
							tushumingchengOption.setAttribute("value",options[i]);
							tushumingchengOption.setAttribute("class","tushumingchengOption");
							if(ruleForm.tushumingcheng == options[i]){
								tushumingchengOption.setAttribute("selected","selected");
							}
							tushumingchengOption.innerHTML = options[i];
							//修改 回显
							if(ruleForm.tushumingcheng != null && ruleForm.tushumingcheng != '' && options[i] == ruleForm.tushumingcheng){
								tushumingchengOption.setAttribute("selected","selected");
							}
							$("#tushumingchengSelect").append(tushumingchengOption);
						}
					}
				});
			}		
			function tushumingchengSelect2Change(){
				var options = document.getElementById("tushumingchengSelect").options;
				var index = document.getElementById("tushumingchengSelect").selectedIndex;
				var colVal = options[index].value;
				http("follow/tushuxinxi/tushumingcheng","GET",{
					tableName: "tushuxinxi",
					columnName: "tushumingcheng",
					columnValue: colVal
				},(res)=>{
					if(res.code == 0){
						if(res.data != null && res.data.tushufenlei != null){
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "tushupingjia/info/" + id,
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("tushupingjia/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("tushupingjia/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
