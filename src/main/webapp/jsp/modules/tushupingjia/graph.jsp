...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">图书评价统计</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>图书评价统计</span></li>
							</ol>
						</div>
					</div>
				</div>
	...
	function draw(){
		...
		var myChart = echarts.init(document.getElementById('main'),'macarons');
				...
				myChart.setOption({
			title: {text : '图书评价',left: 'center',top: 20},
			tooltip: {
				trigger: 'item',
	...
	$.ajax({ 
		type: "GET",
		url: baseUrl+"value/tushupingjia/"+xColumnName+'/'+yColumnName,
		data:{ },
	...
	function group(colName){
		$.ajax({ 
			type: "GET",
			url: baseUrl+"group/tushupingjia/"+colName,
			data:{	tableName: "tushupingjia",
					columnName: colName
					},
			beforeSend: function(xhr) {
				xhr.setRequestHeader("token", window.sessionStorage.getItem('token'));
